    ...
    */
    ...
    async read(id) {
        ...
        try {
            ...
            return new Videogame(parsed.id, parsed.name, parsed.description, parsed.platform, parsed.genre, parsed.developer, parsed.releaseYear, parsed.multiplayer, parsed.estimatedHours, parsed.marketValue);
        }
        catch (error) {
            if (error.code === 'ENOENT') {
